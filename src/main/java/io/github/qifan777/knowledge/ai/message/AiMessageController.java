...
//        String medias = json1.getString("medias");
//        JSONObject json2 = new JSONObject(medias);
//        String data = json2.getString("data");
//        MultipartFile file1;
//        //如果data以http://开头，则转为url
//        if (data.startsWith("http://") || data.startsWith("https://")) {
//            //从阿里云下载文件，url是data
//            URL url = new URL(data);
//            URLConnection connection = url.openConnection();
//            String contentType = connection.getContentType(); // 获取媒体类型，如 image/jpeg
//            String fileName = data.substring(data.lastIndexOf('/') + 1); // 提取文件名
//
//            // 2. 获取文件流
